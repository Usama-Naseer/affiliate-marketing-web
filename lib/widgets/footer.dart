                   ...
                   Column(
                     ...
                     children: [
                       Text(
                         ...
                         style: GoogleFonts.lato(
                           textStyle: const TextStyle(
                               fontSize: 15, fontWeight: FontWeight.w600,color: AppColors.whiteColor),
                         ),
                       ),
                       const SizedBox(
                         height: 10,
                       ...
                       Text(
                         ...
                         style: GoogleFonts.lato(
                           textStyle: const TextStyle(
                               fontSize: 14, fontWeight: FontWeight.w300,color: AppColors.whiteColor),
                         ),
                       ),
                       const SizedBox(
                         height: 10,
                 ...
                 Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                   SizedBox(
                     ...
                     child: Text(
                       ...
                       style: GoogleFonts.lato(
                         textStyle: const TextStyle(
                             fontSize: 15, fontWeight: FontWeight.w300,color: AppColors.whiteColor),
                       ),
                     ),
                   ),
                 ]),
               ...
               children: [
                 if (HelperFunctions.getPlatform(context) != Platform.mobile)
                   Column(
                       ...
                       children: [
                         Text(
                           "Whenever you shop with these partners, we might earn affiliate commissions. It's our way of bringing you more fantastic deals and offers. "
